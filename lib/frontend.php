...
box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.75);">
                                <em><strong>Per realizzare una prenotazione bisogna completare i dati dall\'alto verso il basso, da sinistra verso destra nel seguente ordine:</strong></em>
                                <ul>
                           ...
                           '.$TitFinPren.'
                            ...
                            <div style="float:left;margin-left:20px;">
                                ...
                                <p>					
                                    ...
                                    <input type="hidden" id="UrlAjax" value="'.admin_url( 'admin-ajax.php' ).'" name="UrlAjax"/>
